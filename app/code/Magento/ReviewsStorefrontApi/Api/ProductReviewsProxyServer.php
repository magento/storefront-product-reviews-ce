...
class ProductReviewsProxyServer implements \Magento\ReviewsStorefrontApi\Proto\ProductReviewsInterface
{
    ...
    {
        // convert data from \Magento\ReviewsStorefrontApi\Api\Data\CustomerProductReviewResponse
        // to \Magento\ReviewsStorefrontApi\Proto\CustomerProductReviewResponse
        /** @var \Magento\ReviewsStorefrontApi\Api\Data\CustomerProductReviewResponse $value **/
        $p = function () use ($value) {
            $r = new \Magento\ReviewsStorefrontApi\Proto\CustomerProductReviewResponse();
            $res = [];
            foreach ($value->getItems() as $item1) {
                // convert data from \Magento\ReviewsStorefrontApi\Api\Data\ReadReview
                // to \Magento\ReviewsStorefrontApi\Proto\ReadReview
