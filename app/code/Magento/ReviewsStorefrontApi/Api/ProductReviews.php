...
use \Magento\ReviewsStorefrontApi\Proto\CustomerProductReviewResponse;
...
class ProductReviews implements ProductReviewsInterface
{
    ...
    {
        // convert data from \Magento\ReviewsStorefrontApi\Proto\CustomerProductReviewResponse
        // to \Magento\ReviewsStorefrontApi\Api\Data\CustomerProductReviewResponse
        /** @var \Magento\ReviewsStorefrontApi\Proto\CustomerProductReviewResponse $value **/
        $p = function () use ($value) {
            $r = new \Magento\ReviewsStorefrontApi\Api\Data\CustomerProductReviewResponse();
            $res = [];
            foreach ($value->getItems() as $item1) {
                // convert data from \Magento\ReviewsStorefrontApi\Proto\ReadReview
                // to \Magento\ReviewsStorefrontApi\Api\Data\ReadReview
