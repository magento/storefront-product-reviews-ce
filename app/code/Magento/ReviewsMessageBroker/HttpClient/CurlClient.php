...
namespace Magento\ReviewsMessageBroker\HttpClient;
...
class CurlClient
{
     ...
     * @throws \Exception
     */
    private function invokeApi(string $url, array $additionalCurlOpts, array $headers = []): array
    {
     ...
     * @return array
     */
    private function getCurlOptions(array $customCurlOpts = [], array $headers = []): array
    {
