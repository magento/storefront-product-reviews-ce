...
namespace Magento\ReviewStorefrontConfig\Console\Command;

use Magento\Framework\Console\Cli;
use Magento\Framework\Exception\LocalizedException;
use Magento\ReviewStorefrontConfig\Model\Installer;
...
class Config extends Command
{
     ...
     * @var string
     */
    private const COMMAND_NAME = 'storefront:review:init';
